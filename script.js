import { Globe } from 'https://unpkg.com/globe.gl@2.29.0/dist/globe.gl.min.js';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    try {
        ...
        alert('Failed to load globe. Please try refreshing the page.');
        return;
    }
    ...
    if (!controls) {
        ...
        alert('Failed to initialize globe controls.');
        return;
    }
